...
document.addEventListener("DOMContentLoaded", () => {
  ...
  document.getElementById("display-name").textContent = userData.name || "ثبت نشده";
  document.getElementById("display-name-again").textContent = userData.name || "ثبت نشده";
  document.getElementById("display-phone").textContent = userData.phone || "ثبت نشده";
});
